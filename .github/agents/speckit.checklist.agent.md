...
3. **Clarify intent (dynamic)**: Derive up to THREE initial contextual clarifying questions (no pre-baked catalog). They MUST:
   ...
   5. Formulate questions chosen from these archetypes:
      ...
      - Scenario class gap (e.g., "No recovery flows detected—are corrective migration / partial failure paths in scope?")
...
6. **Generate checklist** - Create "Unit Tests for Requirements":
  ...
  - Include forward recovery when state mutation occurs: "Are corrective migration and verified restore requirements defined for migration failures? [Gap]"
