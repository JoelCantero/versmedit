...
- [X] T049 [US5] Add the official shadcn navigation menu to the localized home with anonymous Login and disabled Sign up items, authenticated Log out behavior, and focused component coverage in src/components/app-navigation.tsx, src/app/[locale]/page.tsx, src/messages/en.json, src/messages/es.json, src/messages/ca.json, and tests/unit/app-navigation.test.tsx
- [X] T050 [US5] Add system-aware light/dark mode with `next-themes`, a localized navigation-menu toggle, and focused component coverage in src/components/theme-provider.tsx, src/app/[locale]/layout.tsx, src/components/app-navigation.tsx, src/messages/en.json, src/messages/es.json, src/messages/ca.json, and tests/unit/app-navigation.test.tsx
...
- [X] T052 [US5] Replace all hardcoded application-facing branding with the configured project name in src/app/[locale]/page.tsx, src/app/[locale]/login/page.tsx, src/app/[locale]/login/error/page.tsx, src/lib/auth.ts, src/messages/en.json, src/messages/es.json, src/messages/ca.json, tests/unit/auth.test.ts, and tests/unit/login-routes.test.tsx
...
- [X] T054 [US5] Add a shadcn navigation-menu language selector with CA, ENG, and ES options in src/components/app-navigation.tsx that preserves the active pathname, marks the current locale, performs canonical full-document locale transitions, and is covered in tests/unit/app-navigation.test.tsx
- [X] T055 [US5] Add a responsive shadcn vertical separator between account actions and language/theme preferences in src/components/app-navigation.tsx and assert its rendered primitive in tests/unit/app-navigation.test.tsx
- [X] T056 [US5] Center the vertical separator and absolutely positioned dark-mode icon in src/components/app-navigation.tsx so their computed vertical centers equal the 36px navigation-control center
- [X] T057 [US5] Replace the language selector translation glyph with a 16×16px Lucide globe icon in src/components/app-navigation.tsx
- [X] T058 [US5] Add a 4px computed gap between the globe icon and active locale label in src/components/app-navigation.tsx without horizontal overflow
