...
**Primary Dependencies**: Next.js (App Router) + React, Tailwind CSS, Prisma, Zod, Auth.js (NextAuth), Pino (structured logging) [+ feature-specific dependencies; reuse the provider-neutral HTTP email boundary when email authentication is in scope]
