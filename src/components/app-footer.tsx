...
export async function AppFooter({ locale, supportEmail }: AppFooterProps) {
  ...
  return (
    <footer className="shrink-0 border-t border-border bg-background px-4 py-3 text-sm text-foreground sm:px-6">
      <div className="mx-auto flex w-full max-w-7xl min-w-0 flex-wrap items-center justify-center gap-x-6 gap-y-2 sm:justify-end">
        <a
        ...
        <nav aria-label={footerTranslations("navigationLabel")}>
