...
- **SC-010**: In automated lifecycle verification, 100% of activated accounts have exactly one authoritative acceptance record matching the consumed link's server-selected policy versions and time, while 0 active-account signup attempts modify an acceptance record.
