...
const es: Record<TranslationKey, string> = {
  ...
  'myVerses.noCategory': 'Sin categoría',
  'myVerses.level': 'Nivel',
  'myVerses.edit': 'Editar',
  'myVerses.delete': 'Eliminar',
  'myVerses.deleteDialogTitle': '¿Eliminar este versículo?',
  'myVerses.deleteDialogDescription': '¿Seguro que quieres eliminar {reference}? Esta acción no se puede deshacer.',
  'myVerses.deleteDialogConfirm': 'Sí, eliminar versículo',
  'myVerses.deleteDialogCancel': 'Conservar versículo',
